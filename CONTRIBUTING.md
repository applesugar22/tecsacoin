Contributing to tecsacoin Core
============================

The tecsacoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the tecsacoin Core project, and is not to be
confused with overall tecsacoin Network Protocol consensus changes.

Whether a pull request is merged into tecsacoin Core rests with the project merge
...
Patches that change tecsacoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the tecsacoin consensus, it must have been
...
The project leader is the release manager for each tecsacoin Core release.
