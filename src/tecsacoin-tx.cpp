...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("tecsacoin tecsacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tecsacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tecsacoin transaction") + "\n" +
                               "  tecsacoin-tx [options] -create [commands]   " + _("Create hex-encoded tecsacoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tecsacoin transaction
