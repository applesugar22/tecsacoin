...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop tecsacoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "tecsacoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* tecsacoin features */
        {"tecsacoin", "masternode", &masternode, true, true, false},
        {"tecsacoin", "listmasternodes", &listmasternodes, true, true, false},
        {"tecsacoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tecsacoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tecsacoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"tecsacoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"tecsacoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"tecsacoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tecsacoin", "masternodedebug", &masternodedebug, true, true, false},
        {"tecsacoin", "startmasternode", &startmasternode, true, true, false},
        {"tecsacoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tecsacoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tecsacoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tecsacoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tecsacoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tecsacoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tecsacoin", "mnbudget", &mnbudget, true, true, false},
        {"tecsacoin", "preparebudget", &preparebudget, true, true, false},
        {"tecsacoin", "submitbudget", &submitbudget, true, true, false},
        {"tecsacoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tecsacoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tecsacoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tecsacoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tecsacoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tecsacoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tecsacoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tecsacoin", "checkbudgets", &checkbudgets, true, true, false},
        {"tecsacoin", "mnsync", &mnsync, true, true, false},
        {"tecsacoin", "spork", &spork, true, true, false},
        {"tecsacoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> tecsacoin-cli " + methodname + " " + args + "\n";
}
