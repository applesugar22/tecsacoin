...
/* *** BEGIN OBFUSCATION MAGIC - tecsacoin **********
    ...
    if (fMasterNode) {
        ...
        BOOST_FOREACH (const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat tecsacoin and make it unusable. To
                stop these kinds of attacks 1 in 10 successful transactions are charged. This
                adds up to a cost of 0.001 tecsacoin per transaction on average.
            */
            if (r <= 10) {
...
bool CObfuscationPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    CAmount nBalanceNeedsAnonymized = nAnonymizetecsacoinAmount * COIN - pwalletMain->GetAnonymizedBalance();
...
void ThreadCheckObfuScationPool()
{
    ...
    RenameThread("tecsacoin-obfuscation");
