...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("tecsacoin Core"),
     ...
     * override -datadir in the tecsacoin.conf file in the default data directory
     * (to be consistent with tecsacoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
