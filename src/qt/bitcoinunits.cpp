...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case tecsacoin:
        return QString("tecsacoin");
    case mECA:
        return QString("mtecsacoin");
    case uECA:
        return QString::fromUtf8("utecsacoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case tecsacoin:
            return QString("tecsacoin");
        case mECA:
            return QString("Milli-tecsacoin (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-tecsacoin (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
