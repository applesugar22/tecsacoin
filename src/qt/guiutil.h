...
/** Utility functions used by the tecsacoin Qt UI.
 */
namespace GUIUtil
{
...
// Render tecsacoin addresses in monospace font
...
// Parse "tecsacoin:" URI into recipient object, return true on successful parsing
