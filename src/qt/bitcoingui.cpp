                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("tecsacoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&tecsacoin Project"), this);
    webmainAction->setStatusTip(tr("tecsacoin Project Website"));
    ...
    facebookAction->setStatusTip(tr("tecsacoin Facebook"));
    ...
    twitterAction->setStatusTip(tr("tecsacoin Twitter"));
    ...
    discordAction->setStatusTip(tr("tecsacoin Discord"));
    ...
    youtubeAction->setStatusTip(tr("tecsacoin Youtube"));
    ...
    telegramAction->setStatusTip(tr("tecsacoin Telegram"));
    ...
    redditAction->setStatusTip(tr("tecsacoin Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap tecsacoin"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell tecsacoin Coin (tecsacoin)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    tecsacoinBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&tecsacoin block explorer"), this);
    tecsacoinBlockExplorerAction->setStatusTip(tr("tecsacoin blockchain explorer"));
    tecsacoinBlockExplorerAction->setToolTip(tecsacoinBlockExplorerAction->statusTip());
    tecsacoinBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&tecsacoin Project Github"), this);
    githubAction->setStatusTip(tr("tecsacoin Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a tecsacoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tecsacoin: URIs)"));
...
//    }
    ...
    connect(tecsacoinBlockExplorerAction, SIGNAL(triggered()), this, SLOT(tecsacoinBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About tecsacoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about tecsacoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for tecsacoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your tecsacoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified tecsacoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a tecsacoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the tecsacoin Core help message to get a list with possible tecsacoin command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(tecsacoinBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("tecsacoin Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.tecsacoin.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/tecsacoin.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/tecsacoin4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/tecsacoincryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/tecsacoin-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::tecsacoinBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/tecsacoin/tecsacoin/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to tecsacoin network", "", count));
}
...
{
    QString strTitle = tr("tecsacoin Core"); // default title
