...
/* tecsacoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "tecsacoin"
#define QAPP_ORG_DOMAIN "tecsacoinproject.org"
#define QAPP_APP_NAME_DEFAULT "tecsacoin-Qt"
#define QAPP_APP_NAME_TESTNET "tecsacoin-Qt-testnet"
