...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/tecsacoin-cli.cpp \
           src/tecsacoin-tx.cpp \
           src/tecsacoin.cpp \
           src/db.cpp \
           ...
           src/qt/tecsacoin.cpp \
           src/qt/tecsacoinstrings.cpp \
...
RESOURCES += src/qt/tecsacoin.qrc src/qt/tecsacoin_locale.qrc

TRANSLATIONS += src/qt/locale/tecsacoin_bg.ts \
                src/qt/locale/tecsacoin_de.ts \
                src/qt/locale/tecsacoin_en.ts \
                src/qt/locale/tecsacoin_es.ts \
                src/qt/locale/tecsacoin_fi.ts \
                src/qt/locale/tecsacoin_fr.ts \
                src/qt/locale/tecsacoin_it.ts \
                src/qt/locale/tecsacoin_ja.ts \
                src/qt/locale/tecsacoin_pl.ts \
                src/qt/locale/tecsacoin_pt.ts \
                src/qt/locale/tecsacoin_ru.ts \
                src/qt/locale/tecsacoin_sk.ts \
                src/qt/locale/tecsacoin_sv.ts \
                src/qt/locale/tecsacoin_vi.ts \
                src/qt/locale/tecsacoin_zh_CN.ts \
                src/qt/locale/tecsacoin_zh_TW.ts
