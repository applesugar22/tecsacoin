...
In order to support loading of multiple wallets in tecsacoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tecsacoin.cpp.
...
Changes to tecsacoin.cpp
----------------------
tecsacoin.cpp is the entry point into tecsacoin-qt, and as such, will require some minor modifications to provide hooks for
